/* ==========================================================================
   contact.js — EmailJS contact form (preserves existing service/template)
   ========================================================================== */
...
(function () {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (typeof emailjs === "undefined") {
            setStatus("Email service is unavailable right now. Please email me directly.", "error");
            return;
        }
        ...
        emailjs
            .send("service_4c98q07", "template_dqv7zdp", params)
            .then(() => {
            ...
            .catch((err) => {
                setStatus("Failed to send message. Please try again or email me directly.", "error");
